...
namespace Com.H.Threading.Scheduler
{
    public class HTaskControlProperties : IHTaskControlProperties, IDisposable
    {
        ...
        public int? RepeatDelayInterval
        {
            get
            {
                if ((this.TaskItem["repeat"]?.Attributes["delay_interval"] ??
                    this.TaskItem["repeat"]?.Attributes["delay-interval"]) == null
                    ||
                    !int.TryParse((this.TaskItem["repeat"]?.Attributes["delay_interval"] ??
                    this.TaskItem["repeat"]?.Attributes["delay-interval"]), out int delay)
                    ) return null;
                return delay;
            }
        }
